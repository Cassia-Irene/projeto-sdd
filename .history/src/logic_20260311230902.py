...
def obter_dados_mapa_calor():
    """
    Filtra as coordenadas e o nível de risco das famílias para o frontend desenhar o Heatmap.
    Retorna listas separadas para facilitar o plot no Matplotlib ou em bibliotecas web (Leaflet/Chart.js).
    """
    familias = carregar_familias()
    ...
    for dados in familias.values():
        ...
        niveis_risco.append(dados['inseguranca']) # Grave, Moderada, Leve, Seguro
