...
def gerar_dashboard_html():
    ...
    # Rotaciona o eixo X e mostra apenas 1 data a cada 5 (evita o borrão preto)
    ...
    # ==========================================
    # 3. MAPA DO FOLIUM (Heatmap Real em São Luís)
    # ==========================================
    ...
    # Define "peso" (intensidade do calor) com base na insegurança
    ...
    mapa_html = mapa._repr_html_() # Puxa o HTML do mapa para embutir na página
