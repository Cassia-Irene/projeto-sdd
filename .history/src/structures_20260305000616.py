...
def carregar_bairros():
    """
    Lê o arquivo JSON gerado pela API e retorna um CONJUNTO (Set).
    Requisito: Parte 1 - Modelagem de bairros.
    """
...
cadastro_familias = {
    "123.456.789-00": {
        ...
        "bairro": "Coroadinho",https://servicodados.ibge.gov.br/api/docs/localidades?versao=1
