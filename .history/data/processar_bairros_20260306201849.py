...
def automatizar_extracao_coordenadas():
    ...
    try:
        # 1. Carrega o novo dataset focado em São Luís
        df = kagglehub.dataset_load(
            KaggleDatasetAdapter.PANDAS,
            "evanildobarros/bairrosdesaoluis",
            "bairros_saoluis.csv", # Verifique o nome exato do arquivo no Kaggle após o download
        )
        ...
        # Geralmente são 'bairro', 'lat'/'latitude' e 'long'/'longitude'
        ...
        # 3. Transforma o DataFrame em uma lista de dicionários para o JSON
        bairros_coords = []
