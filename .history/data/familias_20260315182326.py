...
def gerar_familias(total_alvo: int = 80) -> None:
    ...
    while i < total_alvo:
        ...
        """
        tem_menor_18: probabilidade base do SEDES, aumentada proporcionalmente ao tamanho da família — famílias com 4+ membros têm chance maior
        # de incluir crianças ou adolescentes.
        """
