...
def classificar_inseguranca(renda: float, membros: int, tem_menor: bool, escolaridade_baixa, pts_moradia, vulnerabilidade_territorial=2, ja_recebe_auxilio: bool = False,) -> str:
    """
