...
def classificar_inseguranca(renda: float, 
                            membros: int, tem_menor: bool, escolaridade_baixa: bool, pts_moradia: int, vulnerabilidade_territorial=2, ja_recebe_auxilio: bool = False,) -> str:
    """
